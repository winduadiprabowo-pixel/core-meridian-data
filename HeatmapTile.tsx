...
const HeatmapTile = memo(() => {
  ...
  const btnBase = useMemo<React.CSSProperties>(() => ({
    ...
    border: '1px solid rgba(34,211,238,0.12)', background: 'transparent',
    color: 'rgba(138,138,158,0.50)', cursor: 'pointer',
  }), []);

  const btnActive = useMemo<React.CSSProperties>(() => ({
    fontFamily: "'JetBrains Mono', monospace", fontSize: 9, padding: '2px 8px', borderRadius: 3,
    border: '1px solid rgba(0,238,255,0.35)', background: 'rgba(0,238,255,0.10)',
  ...
  const backendColor = useMemo(() => {
    ...
    if (backend === 'webgl2') return 'rgba(0,238,255,0.50)';
    return 'rgba(138,138,158,0.30)';
  }, [backend]);
  ...
  return (
    <GlassCard style={{ height: 300, display: 'flex', flexDirection: 'column', padding: '10px 10px 8px' }}>
      ...
      <div ref={containerRef} style={{ flex: 1, position: 'relative', minHeight: 0 }}>
        {loading && (
          <div style={{ position: 'absolute', inset: 0, display: 'flex', alignItems: 'center', justifyContent: 'center', fontFamily: "'JetBrains Mono', monospace", fontSize: 10, color: 'rgba(0,238,255,0.40)' }}>
        ...
        {hoverCoin && (
          <div style={{
            ...
            background: 'rgba(5,5,14,0.95)', border: '1px solid rgba(34,211,238,0.2)',
            ...
            <div style={{ color: 'var(--zm-text-secondary)', marginBottom: 2 }}>
            ...
            <div style={{ color: hoverCoin.change >= 0 ? 'rgba(34,255,170,0.90)' : 'rgba(255,68,136,0.90)' }}>
      ...
      <div style={{ display: 'flex', gap: 6, marginTop: 6, alignItems: 'center', fontFamily: "'JetBrains Mono', monospace", fontSize: 8, color: 'rgba(138,138,158,0.30)' }}>
