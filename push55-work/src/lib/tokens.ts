...
export const COLOR = Object.freeze({
  ...
  // Emerald
  emerald300: 'var(--zm-positive)',
  emerald400: 'var(--zm-positive)', // positive
  emerald500: 'rgba(16,185,129,1)',
  emerald600: 'rgba(5,150,105,1)',

  // Rose
  rose300: 'rgba(255,68,136,0.70)',
  rose400: 'var(--zm-negative)',   // negative
  rose500: 'rgba(244,63,94,1)',
  rose600: 'rgba(225,29,72,1)',

  // Amber
  amber300: 'var(--zm-warning)',
  amber400: 'var(--zm-warning)',   // warning / whale
  amber500: 'var(--zm-warning)',

  // Violet
  violet300: 'var(--zm-violet)',
  violet400: 'var(--zm-violet)', // DeFi / OI
  violet500: 'var(--zm-violet)',

  // Cyan
  cyan300: 'rgba(103,232,249,1)',
  cyan400: 'var(--zm-cyan)',    // tools / surge
...
export const SEMANTIC = Object.freeze({
  dark: {
    bgBase:        'var(--zm-bg-base)',
    bgElevated:    'rgba(10,10,24,1)',
    bgCard:        'var(--zm-surface-1)',
    bgCardHover:   'var(--zm-surface-2)',
    border:        'rgba(96,165,250,0.07)',
    borderHover:   'rgba(96,165,250,0.22)',
    textPrimary:   'var(--zm-text-primary)',
    textSecondary: 'rgba(148,163,184,0.58)',
    textFaint:     'rgba(148,163,184,0.28)',
    sidebarBg:     'var(--zm-sidebar-bg)',
    topbarBg:      'var(--zm-topbar-bg)',
  },
  light: {
...
export const SECTION_ACCENT = Object.freeze({
  ...
  onchain:    { accent: COLOR.emerald400,accentBg: 'var(--zm-positive-bg)',  accentBorder: 'rgba(52,211,153,0.25)'  },
  defi:       { accent: COLOR.violet400, accentBg: 'var(--zm-violet-bg)', accentBorder: 'rgba(167,139,250,0.25)' },
  ...
  tools:      { accent: COLOR.cyan400,   accentBg: 'rgba(0,238,255,0.10)',  accentBorder: 'rgba(34,211,238,0.25)'  },
} as const);
