...
const FundingRow = memo(({ item }: { item: FundingRate }) => {
  ...
  return (
    <div
      role="row"
      aria-label={item.symbol + ' funding rate: ' + (item.rate * 100).toFixed(4) + '%'}
      style={{
    ...
    <div style={{ padding: '10px 16px', borderBottom: '1px solid var(--zm-divider)' }}>
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '6px' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
          <span style={{ fontFamily: "'IBM Plex Mono', monospace", fontSize: '10px', fontWeight: 600, color: 'rgba(34,255,170,0.90)' }}>
            {'L ' + longPct.toFixed(1) + '%'}
          </span>
          <span style={{ fontFamily: "'IBM Plex Mono', monospace", fontSize: '10px', fontWeight: 600, color: 'rgba(255,68,136,0.90)' }}>
    ...
    <div style={{ padding: '12px 16px' }}>
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '8px' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
          ...
          <span style={{ fontFamily: "'IBM Plex Mono', monospace", fontSize: '12px', fontWeight: 700, color: 'var(--zm-negative)' }}>
            {'$' + formatCompactNum(longUsd)}
          </span>
        </div>
        <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
          <span style={{ fontFamily: "'IBM Plex Mono', monospace", fontSize: '12px', fontWeight: 700, color: 'var(--zm-positive)' }}>
      ...
      <div style={{ position: 'relative', height: '8px', borderRadius: '999px', overflow: 'hidden', background: 'var(--zm-surface-2)' }}>
        ...
        />
        <div
          style={{ position: 'absolute', right: 0, top: 0, height: '100%', borderRadius: '0 999px 999px 0', width: shortPct + '%', background: 'rgba(34,255,170,0.70)', willChange: 'width', transition: 'width 0.5s ease' }}
        />
      </div>
    </div>
  );
...
const DRV_CARD_STYLE = Object.freeze({
...
const DRV_PANEL_HDR = Object.freeze({
...
const Derivatives = memo(() => {
  ...
  // Use module-level constants (see top of file)
  const CARD_STYLE = DRV_CARD_STYLE;
  const PANEL_HDR  = DRV_PANEL_HDR;
    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
      ...
      <div style={{ display: 'flex', flexWrap: 'wrap', alignItems: 'center', gap: '12px' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '6px', padding: '3px 8px', borderRadius: '6px', background: 'var(--zm-positive-bg)', border: '1px solid var(--zm-positive-border)' }}>
          ...
          <span style={{ fontFamily: "'Space Mono', monospace", fontSize: '10px', color: 'rgba(34,255,170,0.90)' }}>
        ...
        <button
          ...
          onMouseEnter={(e) => { e.currentTarget.style.background = 'var(--zm-accent-dim)'; e.currentTarget.style.color = 'var(--zm-cyan)'; }}
              ...
              recentLiqs.map(ev => {
                ...
                return (
                  ...
                  >
                    ...
                    <span
                      style={{ fontFamily: "'IBM Plex Mono', monospace", fontSize: '10px', fontWeight: 600, marginLeft: 'auto', color: ev.isMajor ? 'var(--zm-warning)' : 'var(--zm-text-secondary)' }}
                    >
