...
const SkeletonPage = memo(() => (
  <div style={{ display: 'flex', flexDirection: 'column', gap: '20px', animation: 'fadeIn 0.3s ease' }}>
    ...
    <div style={{ display: 'grid', gridTemplateColumns: '3fr 2fr', gap: '16px' }}>
      <div style={{ background: 'var(--zm-surface-1)', border: '1px solid rgba(255,255,255,0.06)', borderRadius: '12px', padding: '16px', minHeight: 280 }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
        <div style={{ background: 'var(--zm-surface-1)', border: '1px solid rgba(255,255,255,0.06)', borderRadius: '12px', padding: '16px', minHeight: 120 }}>
